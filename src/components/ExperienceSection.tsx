      ...
      <div className="container max-w-4xl mx-auto px-6 md:px-4">
        ...
        <div className="mb-8">
          {workExperience.map((job, index) => (
            ...
            >
              <motion.div
                className="mt-3 p-4 bg-background/80 backdrop-blur-sm backdrop-filter rounded-lg border border-blue-500/20 dark:bg-card/10 dark:border-blue-900/10 shadow-sm"
